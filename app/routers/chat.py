...
from app.core.dependencies import get_chat_service, get_conversation_service, get_current_user
...
async def get_answer(
    ...
    stream = await chat_service.stream_answer(
        conversation, request.question, request.document_id, auto_title, current_user.id, current_user.name
    )
